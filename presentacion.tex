...
\usecolortheme[RGB={100,120,150}]{structure} 		% Color del tema
...
\begin{document}
	...
	\begin{frame}
		...
		\tableofcontents[pausesections]		% Hace el efecto de pausa al mostrar cada sesion
	\end{frame}
	...
	\begin{frame}	
		...
		\begin{itemize}
			\item Aplicar conocimientos necesario, para el desarrollo de la aplicacion en la plataforma movil \textbf{Android}.\only
			\item Ofrecer una mejora o innovar un recurso para dispositivos \textbf{Android}.\only
	...
	\begin{frame}[allowframebreaks]
		...
		\frametitle{PROPUESTA}
			...
			por esta forma de multa por sensores de velocidad, no obstante sin quitarle merito a estas reformas por
			 ...
			 \centering {\includegraphics[width=4cm]{./images/logo-cte.jpg}}
			...
			\begin{figure}[H]%%Usando el paquete float
				\centering
